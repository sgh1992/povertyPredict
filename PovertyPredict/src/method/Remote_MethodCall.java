...
import dataBase.DB;
import dataBase.DB1;
import dataBase.Remote_Campus_DB;
import dataBase.Remote_DB;

public class Remote_MethodCall {
	...
	public HashMap<String, String> getStudentNoMap() throws Exception{
		...
		Remote_Campus_DB db = new Remote_Campus_DB();
		
		String sqlString = "select * from studentbasicinfo";
	...
	public HashMap<String, String> getSidAndYear() throws Exception{
		...
		String sqlString = "select sid,grade from studentbasicinfo";
	...
	public HashMap<String, String> getSidAndOtherInfoMap() throws Exception{
		...
		Remote_Campus_DB db = new Remote_Campus_DB();
		String sqlString = "select sid,gender,nation,college,major,grade from studentbasicinfo where sid >='2010'";
		ResultSet rSet = db.executeQuery(sqlString);
	...
	public List<String> getSidList(){
		Remote_Campus_DB db = new Remote_Campus_DB();
		String sqlString = "select distinct sid from studentbasicinfo";
		ResultSet rSet = null;
